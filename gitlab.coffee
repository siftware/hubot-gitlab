      ...
      when "web"
        ...
        # not code? must be a something good!
          ...
          switch hook.object_kind
            ...
            when "merge_request"
              link = "https://code.siftware.com/#{encodeURI(hook.object_attributes.target.namespace)}/#{encodeURI(hook.object_attributes.target.name)}/merge_requests/#{hook.object_attributes.iid}"
